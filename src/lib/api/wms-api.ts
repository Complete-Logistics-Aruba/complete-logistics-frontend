...
export const receivingOrderLines = {
   ...
   */
  async create(
    line: Omit<ReceivingOrderLine, 'id' | 'created_at'>
  ): Promise<ReceivingOrderLine> {
    try {
      const { data, error } = await supabase
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to create receiving order line')
      );
    }
  },
  ...
  async getByReceivingOrderId(receivingOrderId: string): Promise<ReceivingOrderLine[]> {
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to load receiving order lines')
      );
    }
  },
};
...
export const receivingOrders = {
   ...
   */
  async create(
    order: Omit<ReceivingOrder, 'id' | 'created_at' | 'updated_at'>
    ...
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to create receiving order')
      );
    }
  },
  ...
  async getById(id: string): Promise<ReceivingOrder & { lines: ReceivingOrderLine[] }> {
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to load receiving order')
      );
    }
  },
  ...
  async update(
    id: string,
    updates: Partial<ReceivingOrder>
  ): Promise<ReceivingOrder> {
    try {
      const { data, error } = await supabase
        .from('receiving_orders')
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to update receiving order')
      );
    }
  },
   ...
   */
  async createLines(
    lines: Omit<ReceivingOrderLine, 'id'>[]
  ): Promise<ReceivingOrderLine[]> {
    try {
      const { data, error } = await supabase
        .from('receiving_order_lines')
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to create receiving order lines')
      );
    }
  },
  ...
  async list(): Promise<(ReceivingOrder & { lines?: ReceivingOrderLine[] })[]> {
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to load receiving orders')
      );
    }
  },
};
...
export const shippingOrders = {
   ...
   */
  async create(
    order: Omit<ShippingOrder, 'id' | 'created_at'>
    ...
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to create shipping order')
      );
    }
  },
  ...
  async getAll(): Promise<(ShippingOrder & { lines?: ShippingOrderLine[] })[]> {
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to load shipping orders')
      );
    }
  },
  ...
  async getById(id: string): Promise<ShippingOrder & { lines: ShippingOrderLine[] }> {
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to load shipping order')
      );
    }
  },
  ...
  async update(
    ...
    try {
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to update shipping order')
      );
    }
  },
   ...
   */
  async createLines(
    lines: Omit<ShippingOrderLine, 'id'>[]
  ): Promise<ShippingOrderLine[]> {
    try {
      const { data, error } = await supabase
      ...
      throw new Error(
        formatErrorMessage(error, 'Failed to create shipping order lines')
      );
    }
  },
};
...
export const locations = {
  ...
  async resolve(
    ...
    try {
      ...
      query = rack === 'AISLE' ? query.eq('code', `${warehouse_id}-AISLE`) : query
          .eq('rack', rack)
          .eq('level', level)
  ...
  async getReceivingOrderCSV(receivingOrderId: string): Promise<string> {
    try {
      ...
      const { data, error: listError } = await supabase.storage
        .from('uploads')
        .list(`receiving/${receivingOrderId}`);
