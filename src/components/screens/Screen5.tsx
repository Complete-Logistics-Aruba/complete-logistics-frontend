...
import { Box, Card, CardActionArea, CardContent, Chip, CircularProgress, Container, Typography } from "@mui/material";
								...
								>
									<CardContent sx={{ width: "100%", flexGrow: 1 }}>
										...
										<Box sx={{ display: "flex", gap: 1, justifyContent: "space-between", alignItems: "center" }}>
											<Chip label={receipt.status} size="small" color="warning" variant="outlined" />
											<Chip label={`${receipt.item_count} items`} size="small" variant="outlined" />
										</Box>
									</CardContent>
								</CardActionArea>
							</Card>
