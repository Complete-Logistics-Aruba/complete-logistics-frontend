			...
			>
				...
				>
					<Stack direction="row" spacing={2} sx={{ alignItems: "center", flex: "1 1 auto" }}>
						...
						>
							{/* Use proper dimensions for logo to prevent blurriness */}
							<Logo color={logoColor} height={40} width={160} />
						</Box>
					...
					>
						...
						{/* <NotificationsButton /> */}
						{/* Contacts button commented out */}
						{/* <ContactsButton /> */}
						{/* Vertical divider commented out */}
						{/* <Divider
							flexItem
							orientation="vertical"
							sx={{ borderColor: "var(--MainNav-divider)", display: { xs: "none", md: "block" } }}
						/> */}
						{/* Language switch commented out */}
						{/* <LanguageSwitch /> */}
						<UserButton />
					</Stack>
				</Box>
...
// User info comes from auth context

function UserButton(): React.JSX.Element {
	const popover = usePopover<HTMLButtonElement>();
	const { user } = useAuth();

	// Generate avatar text from user email or name if no avatar is available
