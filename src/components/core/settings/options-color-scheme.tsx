			...
			<Stack direction="row" spacing={2} sx={{ alignItems: "center", flexWrap: "wrap" }}>
				{(
					[
						...
						{ label: "Dark", value: "dark", icon: <MoonIcon />, disabled: true },
						{ label: "System", value: "system", icon: <DevicesIcon />, disabled: true },
					] satisfies { label: string; value: string; icon: React.ReactNode; disabled?: boolean }[]
				).map((option) => (
					<Option
